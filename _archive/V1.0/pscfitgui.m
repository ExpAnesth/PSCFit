...
h1 = uicontrol('Parent',H0, ...
  'Units','normalized', ...   
  'HorizontalAlignment','left', ...
  'Position',[stdXMarg ba1+tmpYOffs-8*dy  textw edith], ...  
  'FontSize',fsz, ...
  'BackgroundColor',[.6 .6 .6], ...
  'Style','text', ...  
...
h1 = uicontrol('Parent',H0, ...
  'Units','normalized', ...
  'HorizontalAlignment','left', ...
  'Position', [la1 ba1+tmpYOffs-9*dy editw 2*edith], ... 
  'FontSize',fsz, ...   
  'BackgroundColor',[1 1 1], ...
  'Style','edit', ...
  'visible', 'on', ...
...
% - scatter plot including popupmenu UIs for axis and operation mode selection
...
sp.scatter(1).cursorModeMenuH=uicontrol('Parent',H0, ...
  'Units','normalized', ...
  'HorizontalAlignment','left', ...
  'Position', [la4-editw 0.5-stdYMarg-5*edith editw edith], ... 
  'FontSize',fsz, ...   
  'Fontweight','bold', ...
