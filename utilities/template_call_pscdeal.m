...
switch compName
  case {'hh-i7'}
    dataPath='e:\_data\_IPSCFit\example_project\';
    plotPath='e:\_data\_IPSCFit\example_project\results_figures\';
  case {'hh64','hh-i5'}
    dataPath='e:\_data\_IPSCFit\example_project\';
    plotPath='e:\_data\_IPSCFit\example_project\results_figures\';
  otherwise
...
ds.indepParLabel={'Control','conc 1','conc 2','washout'};
% name suffix of files produced by threshdetgui/PSCFitgui
...
% bursts with at least partly overlapping rise times). Full set:
ds.cPscDetPar={...
...
% fitted PSCs via function phantosic. Full set:
ds.rawPar={...
...
ix=ix+1;
ds.plotPar(ix).name='tDecay';
ds.plotPar(ix).bin=[2:1:50]; 
ds.plotPar(ix).bin2=2.^[1:.5:6]; 
